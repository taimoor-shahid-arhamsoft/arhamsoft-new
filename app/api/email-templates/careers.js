...
export const careers = ({
  ...
  const fileContent = resumeUrl
    ? `<strong>Resume: <a href="${resumeUrl}" target="_blank">View File</a></strong>`
    : "<strong>Resume:</strong> No file attached";
  const coverLetterContent = coverLetterUrl
    ? `<strong>Cover Letter: <a href="${coverLetterUrl}" target="_blank">View File</a></strong>`
    : "<strong>Cover Letter:</strong> No file attached";
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="details">
            ...
            <strong>Experience:</strong> ${experience} year${experience > 1 ? "s" : ""}<br>
