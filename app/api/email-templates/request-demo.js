...
export const requestDemoFormContent = ({
  name,
  email,
  contactNo,
  selectedOption,
  ...
  const dateInUTC = moment.tz(dateTime, "YYYY-MM-DD HH:mm:ss", "UTC");

  // Format the date in 12-hour format with AM/PM
  const formattedDate = dateInUTC.format("M/D/YYYY h:mm A");
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>You have received a new demo request from a user. Below are the details:</p>
          <div class="details">
            <strong>Name:</strong> ${name}<br>
            <strong>Email:</strong> ${email}<br>
            <strong>Contact No:</strong> ${contactNo}<br>
            <strong>Selected Option:</strong> ${selectedOption}<br>
            <strong>Message:</strong> ${message}<br>
            <strong>Timezone:</strong> ${timezone.label}<br>
            <strong>Preferred Date & Time:</strong> ${formattedDate}<br>
