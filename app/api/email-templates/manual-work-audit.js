...
export const generateManualWorkAuditEmailContent = ({
  name,
  email,
  task,
  ipAddress,
  ...
  return `
      ...
      <head>
        ...
        <title>New Manual Work Audit Request</title>
        <style>
          body {
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>A new Manual Work Audit request has been submitted. Below are the details:</p>
            <div class="details">
              <strong>Name:</strong> ${name}<br>
              <strong>Email:</strong> ${email}<br>
              <strong>Task Shared:</strong> ${task}<br>
