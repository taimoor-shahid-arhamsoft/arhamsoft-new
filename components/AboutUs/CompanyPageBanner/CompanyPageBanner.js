            ...
            <Container className="position-relative">
                <div className="banner-content">
                    ...
                    <div className="text-block">
                        <p>Data on Matrix is a technology firm, helping multi-sectoral businesses build and refine software solutions for over a decade, with people-based services & market-leading technologies. Operating across three countries, our 250+ experts have accomplished 500+ projects, maintaining a 98% CSAT.</p>
                        ...
                        <p className="signature">— [FOUNDER NAME], [TITLE]</p>
                    </div>
